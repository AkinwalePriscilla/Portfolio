...
#### Technical Skills: Excel, SQL, PowerBI, Python, Git
...
Used **Excel** to analyze the Altera Employee Analysis data set I got from Techcrush (Altera Employee Data set). I first understood my dataset after I did the data cleaning. I used pivot table, Correlation analysis, Dashboard [Git Link)
